...
/**
 * @author Halo
 * @create 2021/12/05 下午 01:52
 * @description 解析 Token 中的用户信息 过滤器
 */
@Component
public class TokenContextFilter extends BaseFilter {
    ...
    /**
     * filterOrder：通过 int 值来定义过滤器的执行顺序，数字越大，优先级越低
     */
    @Override
    ...
    public Object run() {
        ...
        try {
            ...
            errorResponse("解析 Token 出错", R.FAIL_CODE, 200);
            return null;
        }
